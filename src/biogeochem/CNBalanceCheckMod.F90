...
contains
  ...
  subroutine NBalanceCheck(this, bounds, num_soilc, filter_soilc, &
    ...
    associate(                                                                             &
         ...
         f_nox_nit           => soilbiogeochem_nitrogenflux_inst%f_nox_nit_col           , & ! Input:  [real(r8) (:) ]  (gN/m2/s) flux of NOx from nitrification; added by fkm for NOx emission

         f_nh3_vol           => soilbiogeochem_nitrogenflux_inst%f_nh3_vol_col           , & ! Input:  [real(r8) (:) ]  (gN/m2/s) soil NH3 volatilization flux; added by fkm for NH3 volatilization
         
         f_nh3_vol_to_atmos  => soilbiogeochem_nitrogenflux_inst%f_nh3_vol_to_atmos_col  , & ! Input:  [real(r8) (:) ]  (gN/m2/s) soil NH3 volatilization flux that escaped to the free Atmos. ; added by fkm for canopy capture
      ...
      do fc = 1,num_soilc
         ...
         if (.not. use_nitrif_denitrif) then
            ...
            col_noutputs(c) = col_noutputs(c) + f_nox_nit(c)      ! added by fkm for NOx emission

            ! col_noutputs(c) = col_noutputs(c) + f_nh3_vol(c)      ! added by fkm for NH3 volatilization
            
            col_noutputs(c) = col_noutputs(c) + f_nh3_vol_to_atmos(c) ! added by fkm for canopy capture
